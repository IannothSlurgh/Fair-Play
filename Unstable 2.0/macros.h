...
#define DUPLICATE_ERROR_FIELD 0x1F0
...
#define MISSING_KEYWORD_ERR "You have not entered a keyword, your options could not be applied."
#define MISSING_IGNORE_ERR "You have not entered an ignored letter, your options could not be applied."
#define NONALPHA_KEYWORD_ERR "Your keyword is not made only of unique letters, your options could not be applied."
#define IGNORE_IN_KEYWORD_ERR "Your keyword contains your ignored letter, your options could not be applied."
#define IGNORE_IN_FILE_ERR "Your file contains your ignored letter, your options could not be applied."
